...
#pragma alloc_text (PAGE, UsbipdHubFilterEvtDevicePrepareHardware)
#endif
...
--*/
{
    ...
    pnpPowerCallbacks.EvtDevicePrepareHardware = UsbipdHubFilterEvtDevicePrepareHardware;
    ...
    if (NT_SUCCESS(status)) {
        ...
        status = WdfDeviceCreateDeviceInterface(
            device,
            &GUID_DEVINTERFACE_UsbipdHubFilter,
        ...
        if (NT_SUCCESS(status)) {
            ...
            //
            status = UsbipdHubFilterQueueInitialize(device);
        }
    }
...
NTSTATUS
UsbipdHubFilterEvtDevicePrepareHardware(
