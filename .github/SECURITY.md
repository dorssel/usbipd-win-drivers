...
Please consult the [Security Advisories](https://github.com/dorssel/usbipd-win-drivers/security/advisories) for any known
outstanding security vulnerabilities in the latest release.

## Reporting a Vulnerability

Please [report vulnerabilities](https://github.com/dorssel/usbipd-win-drivers/security/advisories/new) privately,
